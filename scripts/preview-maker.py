...
THEME_TEST = f"""' Metadata
!$useTheme = "puml-theme-cb_seq_OrRd_9.puml"
!$useTheme = "https://raw.githubusercontent.com/mweagle/C4-PlantUML-Themes/main/palettes/" +  $useTheme
!include $useTheme
...
#print(plantuml_encode(THEME_TEST))
